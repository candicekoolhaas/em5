...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Canna_d\\EM5_stuff\\EM5_experiments\\EM5_2_experiment\\EM5_2.1_lastrun.py',
...
closingSign = visual.ImageStim(
    win=win,
    name="closingSign", 
    image="closing.png", 
    mask=None, anchor='center',ori=0.0, 
    pos=(-0.4, 0.15),
    size=((0.7, 0.7)), colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
        ...
        for thisOneTrial in oneTrial:
            ...
            while continueRoutine:
                ...
                if closing == 1 and not clickables:
                    continueRoutine = False
                    closingSign.setAutoDraw(False)
                
                if  shopper.contains(imageMouse) and closing == 1:
                    closingSign.setAutoDraw(True)
